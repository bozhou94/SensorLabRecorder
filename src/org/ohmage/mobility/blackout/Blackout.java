...
public class Blackout extends TriggerBase
{
	...
	{
		SharedPreferences settings = context.getSharedPreferences(SensorPreferenceActivity.STRESSSENSE, Context.MODE_PRIVATE);
		if (settings.getBoolean(SensorPreferenceActivity.IS_ON, false))
		{
			Intent i = new Intent(context, BlackoutService.class);
